...
@Component({
  selector: 'app-bottom-slide-over-drawer',
  templateUrl: './bottom-slide-over-drawer.component.html',
  styleUrls: ['./bottom-slide-over-drawer.component.scss']
})
export class BottomSlideOverDrawerComponent implements AfterViewInit {
  openPosition = 10000;
  closePosition = 0;
